...
from src.application.dto.model.{{cookiecutter.entity_name_snake_case.lower()}}_schema import {{cookiecutter.entity_name}}Read, {{cookiecutter.entity_name}}Create, {{cookiecutter.entity_name}}Update
